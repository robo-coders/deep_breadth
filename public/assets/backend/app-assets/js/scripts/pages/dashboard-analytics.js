...
/*
  var supportChartLeft = new ApexCharts(
    document.querySelector("#support-tracker-chart-left"),
    supportChartoptionsLeft
  );
  
  var supportChartRight = new ApexCharts(
    document.querySelector("#support-tracker-chart-right"),
    supportChartoptionsRight
  );
*/

//Support Left Chart Start
$.ajax({
  type:"GET",
  url:"/pain/stress/level/before",
  success: function(response) {
    ...
    supportChartLeft.render();

  }

});
//Support Left Chart End

//Support Right Chart Start

  $.ajax({
    type:"GET",
    url:"/pain/stress/level/after",
    success: function(response) {
  ...
  supportChartRight.render();



    }
  });
//Support Right Chart End
