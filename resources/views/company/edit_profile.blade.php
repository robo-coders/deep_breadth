                            ...
                            <ul class="nav nav-pills flex-column mt-md-0 mt-1">
                                <li class="nav-item">
                                    <a class="nav-link d-flex py-75 active" id="account-pill-general" data-toggle="pill" href="#account-vertical-general" aria-expanded="true">
                                        <i class="feather icon-globe mr-50 font-medium-3"></i> General
                                    </a>
                                </li>
                                <li class="nav-item">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <div class="tab-content">
                                            ...
                                            <form action="{{ route('update_company_profile',['id'=>$view->id]) }}" method="post" enctype="multipart/form-data">
                                                @csrf
                                                <div class="media">
                                                    <a href="javascript: void(0);">

                                                        @if(isset($view->avatar))
                                                        <img src="{{ url($view->avatar) }}" class="rounded mr-75"  alt="{{$view->name}}" height="64" width="64">
                                                        @else
                                                        <img src="{{asset('assets/backend/app-assets/images/extras/dummy.png')}}" class="rounded mr-75"  alt="{{$view->name}}" height="64" width="64">
                                                        @endif
                                                    ...
                                                    <div class="media-body mt-75">
                                                        ...
                                                        <p class="text-muted ml-75 mt-50 pull-left"><small>Allowed JPG, GIF or PNG. Max
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                <div class="controls">
                                                                    <label class="pull-left" for="account-first">First Name</label>
                                                                    <input type="text" class="form-control" name="first_name" placeholder="First Name" value="{{$view->name}}" required data-validation-required-message="This username field is required">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                <div class="controls">
                                                                    <label class="pull-left" for="account-name">Last Name</label>
                                                                    <input type="text" class="form-control" name="last_name" placeholder="Last Name" value=" {{$view->last_name}}" data-validation-required-message="This name field is required">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                <div class="controls">
                                                                    <label class="pull-left" for="account-e-mail">E-mail</label>
                                                                    <input type="email" class="form-control" name="email" placeholder="Email" value="{{$view->email}}" required data-validation-required-message="This email field is required">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                <label class="pull-left" for="account-company">Mobile No</label>
                                                                <input type="number" name="mobile" class="form-control" value="{{$view->mobile}}" placeholder="00 XXXXXXXXXX">
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="tab-pane fade " id="account-vertical-password" role="tabpanel" aria-labelledby="account-pill-password" aria-expanded="false">
                                                <form id="changing-password-form" action="{{ route('change_password') }}" method="post">
                                                    @csrf
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                <div class="controls">
                                                                    <label class="pull-left" for="account-old-password">Old Password</label>
                                                                    <input type="password" class="form-control" 
                                                                    name="old_password" id="account-old-password" required placeholder="Old Password" data-validation-required-message="This old password field is required">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                <div class="controls">
                                                                    <label class="pull-left" for="account-new-password">New Password</label>
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                <div class="controls">
                                                                    <label class="pull-left" for="account-retype-new-password">Retype New
                                                                        Password</label>
                                               ...
                                               <!-- <script>
                                                     $("#changing-password-form").submit(function(e){
                                                        e.preventDefault();
                                                        console.log('show me web with changing route')
                                                    });
                                                </script> -->
                                            </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 mb-1">
                                                        <div class="custom-control custom-switch custom-control-inline">
                                                            ...
                                                            <span class="switch-label w-100">Notify me when someone submits Survey</span>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 d-flex flex-sm-row flex-column justify-content-end">
                                                        <button type="submit" class="btn btn-primary mr-sm-1 mb-1 mb-sm-0">Save
