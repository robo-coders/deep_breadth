@extends('backend.admin') @section('body')
<!-- BEGIN: Content-->
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <div class="tab-content">
                                            ...
                                            <form action="{{ route('update_admin_profile',['id'=>$view->id]) }}" method="post" enctype="multipart/form-data">
                                                @csrf
                                                <div class="media">
                                                ...
                                                <hr>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                <label for="account-company">Mobile No</label>
