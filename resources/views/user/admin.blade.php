                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Create a new Admin</h4>
                            </div>
                            <div class="card-content">
                                <div class="card-body">
                                    <form class="form" action="{{ route('admin_created_by_admin') }}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-body">
                                            <div class="row">
                                            ...
                                            @foreach ($views as $view)
                                                <tbody>
                                                    ...
                                                    <td> <img src="{{url($view->avatar)}}" alt="{{$view->name}}" class="img-cirlcle" width="60px" height="60px"></td>
                                                        @else
                                                        <td><img src="{{asset('assets/backend/app-assets/images/extras/dummy.png')}}" alt="{{$view->name}}" class="img-cirlcle" width="60px" height="60px"></td>
                                                        @endif
                                                        <td>{{$view->name}}</td>
                                                        ...
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                                    <a class="dropdown-item" href="{{ route('admin_edit_by_admin',['id'=>$view->id]) }}">Edit</a>
                                                                <a onclick="deleteData({{$view->id}})" class="dropdown-item">Delete</a>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
